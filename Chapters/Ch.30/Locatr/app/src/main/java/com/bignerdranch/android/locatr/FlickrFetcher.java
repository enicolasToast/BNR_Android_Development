...
public class FlickrFetcher {
    ...
    private static final String API_KEY = "786817a1fa3f1c042c00ce1af17257a7";
    ...
    private String buildUrl(Location location) {
        return ENDPOINT.buildUpon()
                ...
                .appendQueryParameter("lat", new Double(location.getLatitude()).toString())
                .appendQueryParameter("lon", new Double(location.getLongitude()).toString())
                .build().toString();
    }
