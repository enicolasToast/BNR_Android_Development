...
public class QuizActivity extends AppCompatActivity {
    ...
    private static final String IS_CHEATER_ARRAY = "is_cheater_array";
    ...
    private boolean[] mIsCheaterBank = null;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mIsCheaterBank = new boolean[mQuestionBank.length];
        ...
        if(savedInstanceState != null) {
            ...
            mIsCheaterBank = savedInstanceState.getBooleanArray(IS_CHEATER_ARRAY);
        }
    ...
    public void onSaveInstanceState(Bundle saveInstanceState) {
        ...
        saveInstanceState.putBooleanArray(IS_CHEATER_ARRAY, mIsCheaterBank);
    }
