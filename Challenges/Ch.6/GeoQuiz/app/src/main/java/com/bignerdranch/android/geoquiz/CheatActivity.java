...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String API_VERSION_STRING = "API Level " + VERSION.SDK_INT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApiVersionText = (TextView) findViewById(R.id.apiVersionText);

        mApiVersionText.setText(API_VERSION_STRING);
