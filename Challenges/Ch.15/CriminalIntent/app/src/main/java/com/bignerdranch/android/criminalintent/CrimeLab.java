...
public class CrimeLab {
    ...
    private CrimeCursorWrapper queryCrimes(String whereClause, String[] whereArgs) {
        Cursor cursor = mDatabase.query(CrimeTable.NAME, new String[] {
            "_rowid_", Cols.UUID, Cols.TITLE, Cols.DATE, Cols.SOLVED, Cols.SUSPECT, Cols.SUSPECT_PHONE
        },
    ...
    private static ContentValues getContentValues(Crime crime) {
        ...
        values.put(Cols.SUSPECT, crime.getSuspect() != null ? crime.getSuspect().getName() : null);
        values.put(Cols.SUSPECT_PHONE, crime.getSuspect() != null ? crime.getSuspect().getPhone() : null);
        return values;
    }
